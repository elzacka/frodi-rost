...
struct RecordingListView: View {
    ...
    private var storageWarning: some View {
        VStack(alignment: .leading, spacing: Space.s2) {
            ...
            Text("Fróði får ikke åpnet databasen på telefonen. Du kan ta opp og hente ut som vanlig, men alt forsvinner når du lukker appen. Installer appen på nytt for å rette feilen.")
                .font(.Frodi.caption)
                .foregroundStyle(Color.Frodi.textSecondary)
